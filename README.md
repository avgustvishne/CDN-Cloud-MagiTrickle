...
Основной генератор — V11.

V11 усиливает контроль IPv4/IPv6, автоматически игнорирует повторяющиеся ASN, ограничивает общий объём prefix и сохраняет предыдущую рабочую версию при подозрительном обновлении.
