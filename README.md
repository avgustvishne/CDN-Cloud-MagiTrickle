...
| Набор | IPv4 | IPv6 |
|---|---:|---:|
| **FULL** | **17 342 CIDR** | **5 281 CIDR** |
| **PERFORMANCE** | **8 371 CIDR** | **1 509 CIDR** |
| **BALANCED** | **15 193 CIDR** | **4 713 CIDR** |
| **MINIMAL** | **8 115 CIDR** | **2 781 CIDR** |
| **ASN ALL** | **12 599 CIDR** | **5 986 CIDR** |
| **ALL-CLOUD** | **17 342 CIDR** | **5 281 CIDR** |

**Обновлено:** `2026-09-17T17:19:00Z` · [полная статистика](data/statistics.json)
...
Данные и количество CIDR обновляются автоматически после успешной генерации и проверок. Последняя генерация: `2026-09-17T17:19:00Z`. [Машиночитаемая статистика](data/statistics.json).
