...
| Набор | IPv4 | IPv6 |
|---|---:|---:|
| **FULL** | **17 342 CIDR** | **5 251 CIDR** |
| **PERFORMANCE** | **1 511 CIDR** | **461 CIDR** |
| **BALANCED** | **15 193 CIDR** | **4 683 CIDR** |
| **MINIMAL** | **8 115 CIDR** | **2 752 CIDR** |
| **ASN ALL** | **12 599 CIDR** | **5 956 CIDR** |
| **ALL-CLOUD** | **17 342 CIDR** | **5 251 CIDR** |

**Обновлено:** `2026-09-17T15:21:02Z` · [полная статистика](data/statistics.json)
...
Данные и количество CIDR обновляются автоматически после успешной генерации и проверок. Последняя генерация: `2026-09-17T15:21:02Z`. [Машиночитаемая статистика](data/statistics.json).
