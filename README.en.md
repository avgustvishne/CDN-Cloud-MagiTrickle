...
**Automated IPv4/IPv6 CIDR and ASN subscriptions for CDN and cloud providers for MagiTrickle.**
...
|---|---|---|---|
| **FULL** | [IPv4](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/full-v4.txt) | [IPv6](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/full-v6.txt) | Maximum coverage of all providers |
| **BALANCED** | [IPv4](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/balanced-v4.txt) | [IPv6](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/balanced-v6.txt) | Balanced coverage and load |
| **MINIMAL** | [IPv4](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/minimal-v4.txt) | [IPv6](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/presets/minimal-v6.txt) | Minimal set of core networks |

## All networks

**IPv4**  
[IPv4 subscription](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/all-cloud-v4.txt)

**IPv6**  
[IPv6 subscription](https://raw.githubusercontent.com/avgustvishne/CDN-Cloud-MagiTrickle/main/data/all-cloud-v6.txt)
...
- **Provider subscriptions** — ready-to-use IP/CIDR lists generated from available sources. They generally provide broader coverage of a specific provider.
- **ASN subscriptions** — IP/CIDR ranges belonging to a specific Autonomous System Number (ASN). They are useful for selecting a specific network or infrastructure.

**In short:** provider subscription — **broader provider coverage**; ASN subscription — **a specific provider network**.

## Providers

Separate IPv4 and IPv6 subscriptions are available for each provider.
